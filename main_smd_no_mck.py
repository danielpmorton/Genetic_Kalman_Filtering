...
from classes import *
from filters import *
from Problems.smd_no_mck import *
from helpers import seedRNG, plot_SMD

seedRNG(0)

# Sample the priors
x0 = np.random.multivariate_normal(mu0_sim, sigma0_sim) # Sample x0 from the prior
...
plot_SMD(time_model.times, sim.xHistory, filtered.muHistory, filtered.sigmaHistory, 
         ...
         ["Position", "Velocity", "Mass", "Damping Coeff.", "Spring Const."])